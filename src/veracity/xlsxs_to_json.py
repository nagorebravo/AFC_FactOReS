...
archivo_excel = 'maldita_dataset/annotation_agreement/<YOUR ANNOTATED FILENAME>.xlsx'  
...
directorio_salida = 'maldita_dataset/'  # puedes usar un path absoluto si prefieres
